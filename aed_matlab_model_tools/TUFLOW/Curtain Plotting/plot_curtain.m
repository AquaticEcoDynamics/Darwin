...
for TL = ts:plot_interval:tf
    ...
    text(0.1,0.9,regexprep(varname,'_',' '),'Color','w','units','normalized','fontsize',16,'FontWeight','bold');
    text(0.1,0.1,datestr(timesteps(i),'dd mmm yyyy HH:MM'),'Color','w','units','normalized','fontsize',16,'FontWeight','bold');
